...
class MainActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding.btnPilihFoto.setOnClickListener { startGallery() }
        binding.btnAnalisis.setOnClickListener { analyzeImage() }
    }
    ...
    private fun setLoading(value: Boolean) {
        runOnUiThread {
            if (value) {
                ...
                binding.btnAnalisis.visibility = View.INVISIBLE
            } else {
                binding.progressIndicator.visibility = View.INVISIBLE
                binding.btnAnalisis.visibility = View.VISIBLE
            }
        }
    }
